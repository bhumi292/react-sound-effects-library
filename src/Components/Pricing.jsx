    ...
    <div className="bg-blue-700 py-24 px-6">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-20 mt-24">
        ...
        {plans.map((item) => (
          ...
          <div
            key={item.id}
            className={`w-[310px] h-[350px] rounded-2xl p-5 text-white ${item.bg}`}
          >
            ...
            {/* Description */}
            <p className="mt-8 text-m leading-8 text-white/90 max-w-xs">
              {item.desc}
            </p>
            ...
            {/* Button */}
            <button className="mt-12 transparent text-white font-semibold px-10 py-4 rounded-lg bg-transparent border border-white/40 transition">
